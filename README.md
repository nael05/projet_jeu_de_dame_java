...
## Règles implémentées
1. Mouvement simple : Un pion se déplace d'une case en diagonale vers l'avant.
2. Prise (Saut) : Un pion peut capturer une pièce adverse en sautant par-dessus vers une case vide, en avant ou en arrière.
3. Priorité de saut : Si une prise est possible, elle est obligatoire.
4. Dames : Elles se déplacent sur n'importe quelle distance en diagonale tant que le chemin est dégagé.
5. Promotion : Un pion devient une dame lorsqu'il atteint la ligne de fond adverse (ligne 0 pour les Blancs, ligne 9 pour les Noirs).
